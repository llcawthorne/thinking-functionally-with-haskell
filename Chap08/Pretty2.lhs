...
>  best r ((i,Group x):ids)  = better r (best r ((i,flatten x):ids))
>                                       (best r ((i,x):ids))
...
>  best ws ((i,Group x):ids)  = better w (best ws ((i,flatten x):ids))
>                                        (best ws ((i,x):ids))
>                               where w = head ws
>  better r lx ly = if fits r lx then lx else ly
>  fits r x | r<0 = False
